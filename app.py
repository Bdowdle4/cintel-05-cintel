...
ui.page_opts(title="Constantly Varied Midwest Weather", window_title="Dowdle P5", fillable=True)


# Note the with statement to create the sidebar followed by a colon
# Everything in the sidebar is indented consistently
with ui.sidebar(open="open"):
    ui.h2("Which seasons will we see today?", class_="text-center")
    ui.p(
...
with ui.card(full_screen=True):
    ui.card_header("Most Recent Readings ⏰", style="background-color: green; color: white;")
...
with ui.card():
    ui.card_header("Current Trend 🌡️", style="background-color: green; color: white;")
